    ...
    <div style={{ background: pageBg, width: "100%", minHeight: "100%", fontFamily: font, padding: "20px 16px 32px" }}>
      <div style={{ maxWidth: maxW, margin: "0 auto" }}>
        ...
        <div style={{
          ...
          {data.showLogo && (
            <div style={{ width: 36, height: 36, background: hexAlpha("#ffffff", 0.18), borderRadius: radius.sm, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, fontSize: 14, fontWeight: 800 }}>
          ...
          <div style={{ padding: "24px 28px" }}>
            ...
            {!data.description && !data.contactEmail && !data.contactPhone && !data.socialTwitter && !data.socialInstagram && !data.socialFacebook && !data.socialLinkedin && (
              <div style={{ background: subtleBg, border: `1px dashed ${border}`, borderRadius: radius.md, padding: "20px 16px", textAlign: "center" }}>
                <p style={{ fontSize: 12, color: textMuted, margin: 0, lineHeight: 1.6 }}>
                  Personalised information that you specify in <strong>Step 4: Settings</strong> will be displayed here.
                </p>
              </div>
            )}
          </div>
    ...
    <div style={{ background: pageBg, width: "100%", minHeight: "100%", fontFamily: font, padding: "12px 10px" }}>
      <div style={{ background: cardBg, borderRadius: radius.lg, overflow: "hidden", border: `1px solid ${border}` }}>
        ...
        <div style={{ background: data.brandColor, padding: "14px 16px", display: "flex", alignItems: "center", gap: 10, color: onBrand }}>
          {data.showLogo && (
            <div style={{ width: 28, height: 28, background: hexAlpha("#ffffff", 0.18), borderRadius: radius.sm, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 12, fontWeight: 800 }}>
              {(data.merchantName || "E").slice(0, 1).toUpperCase()}
            </div>
          )}
          <div>
