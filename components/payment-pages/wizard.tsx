  ...
  return (
    <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "48px 40px", textAlign: "center", overflow: "auto" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 12, width: "100%", maxWidth: 500, marginBottom: 32 }}>
        {[
          { icon: "QR", label: "Get QR Code", desc: "Print or share" },
          { icon: "@", label: "Send via Email", desc: "Direct to customers" },
          { icon: "↗", label: "View Analytics", desc: "Track performance" },
        ].map(item => (
          <div key={item.label} style={{ background: C.white, border: `1.5px solid ${C.border}`, borderRadius: radius.lg, padding: "14px", textAlign: "center", cursor: "pointer", transition: "border-color 0.15s" }}
